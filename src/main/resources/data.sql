...
INSERT INTO USUARIO(nome, email, senha) VALUES('Saldanha', 'saldanha@email.com', '$2a$10$3vECm6Jk8LDj3KrcNZGIj.ppL2SliIl5chOcrn.iur8XC2/8513WC');
...
INSERT INTO USUARIO(nome, email, senha) VALUES('Maria', 'maria@email.com', '$2a$10$1KtBfIzcHeIbVRS7Xx.3cufg0DcX3fClrxf5zzbPjaco3nWWdRexy');
...
INSERT INTO USUARIO(nome, email, senha) VALUES('Jose', 'jose@email.com', '');
INSERT INTO USUARIO(nome, email, senha) VALUES('Miguel', 'miguel@email.com', '');
...
INSERT INTO POSTAGEM(titulo, mensagem, data_criacao, autor_id, servico_id) VALUES('O melhor Mecanico', 'Sou o melhor mecanico da cidade', '2021-05-05 18:00:00', 1, 9);
INSERT INTO POSTAGEM(titulo, mensagem, data_criacao, autor_id, servico_id) VALUES('A melhor Diarista', 'Sou a melhor diarista da cidade', '2021-05-05 18:05:00', 2, 10);
INSERT INTO POSTAGEM(titulo, mensagem, data_criacao, autor_id, servico_id) VALUES('O melhor Jardineiro', 'Sou o melhor jardineiro da cidade', '2021-05-05 18:02:00', 3, 4);
INSERT INTO POSTAGEM(titulo, mensagem, data_criacao, autor_id, servico_id) VALUES('O melhor Eletricista', 'Sou o melhor eletricista da cidade', '2021-05-05 18:01:00', 4, 2);
